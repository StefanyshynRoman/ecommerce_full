package com.rstefanyshyn.ecom.order.application;

import com.rstefanyshyn.ecom.order.domain.user.aggregate.User;
import com.rstefanyshyn.ecom.order.domain.user.repository.UserRepository;
import com.rstefanyshyn.ecom.order.domain.user.service.UserReader;
import com.rstefanyshyn.ecom.order.domain.user.service.UserSynchronizer;
import com.rstefanyshyn.ecom.order.domain.user.vo.UserAddressToUpdate;
import com.rstefanyshyn.ecom.order.domain.user.vo.UserEmail;
import com.rstefanyshyn.ecom.order.infrastructure.secondary.service.kinde.KindeService;
import com.rstefanyshyn.ecom.shared.authentication.application.AuthenticatedUser;
